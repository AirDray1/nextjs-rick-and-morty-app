    ...
    <Layout title="The Rick and Morty Next.js" c_length={c_length} l_length={l_length} e_length={e_length}>
      <div className="main-wrapper relative mx-auto bg-white flex justify-center">
        <div className="flex justify-center max-w-(--breakpoint-lg) container h-[40vh]">
          <h1 className="relative z-1 flex items-center justify-center text-5xl/13 font-bold text-gray-800 text-center mb-2
          lg:text-7xl/16">The Rick and Morty with Next.js</h1>
      ...
      <div className="catalog flex flex-col items-center bg-sky-950
      xl:flex-row xl:flex-1 xl:flex-wrap py-5 xl:justify-center">
